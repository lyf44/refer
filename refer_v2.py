...
CATEGORY = ['umbrella', 'bottle', 'cup', 'knife', 'banana', 'apple', 'remote', 'mouse', 'cell phone', 'book', 'toothbrush']
...
class REFER:
	...
	def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
		...
		# filter
		self.data['categories'] = [x for x in instances['categories'] if x['name'] in CATEGORY]
		self.data['category_ids'] = [x['id'] for x in instances['categories'] if x['name'] in CATEGORY]
	...
	def createIndex(self):
		...
		for ref in self.data['refs']:
			...
			# filter
			if category_id not in self.data['category_ids']:
				continue
